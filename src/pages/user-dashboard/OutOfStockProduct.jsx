...
const OutOfStockProduct = () => {
	const { outOfStockProducts, isLoading } = useContext(ProductContext);
	return (
		<>
			<div className="p-4">
				{isLoading && <Spinner />}
				<div className="flex justify-center mb-4">
					<h2 className="text-xl font-bold text-white bg-red-600 px-4 py-2 rounded-md inline-block shadow-md">
